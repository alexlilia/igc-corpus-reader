...
# FOLDERS = [parameters['FOLDER_NAME1'], parameters['FOLDER_NAME2']]

FOLDERS = [parameters['FOLDER_NAME1']]
...
# MODEL_PATH = parameters['MODEL_PATH'] #we don't nee this or clustering
